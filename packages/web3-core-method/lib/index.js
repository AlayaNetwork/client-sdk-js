                        ...
                        if (receipt.status === false || receipt.status === '0x0') {
                            try {
                                ...
                                if (method.handleRevert && method.call === 'platon_sendTransaction') {
                                    ...
                                    revertMessage = await method.getRevertReason(payload.params[0], receipt.blockNumber);
...
Method.prototype.buildCall = function () {
    var method = this, isSendTx = (method.call === 'platon_sendTransaction' || method.call === 'platon_sendRawTransaction'), // || method.call === 'personal_sendTransaction'
