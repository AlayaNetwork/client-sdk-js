...
function funcTypeToBech32(hrp, funcType) {
    if (funcType >= 1000 && funcType < 2000)
        return utils.toBech32Address(hrp, '0x1000000000000000000000000000000000000002');
    if (funcType >= 2000 && funcType < 3000)
        return utils.toBech32Address(hrp, '0x1000000000000000000000000000000000000005');
    if (funcType >= 3000 && funcType < 4000)
        return utils.toBech32Address(hrp, '0x1000000000000000000000000000000000000004');
    if (funcType >= 4000 && funcType < 5000)
        return utils.toBech32Address(hrp, '0x1000000000000000000000000000000000000001');
    if (funcType >= 5000 && funcType < 6000)
        return utils.toBech32Address(hrp, '0x1000000000000000000000000000000000000006');
}
// 使用私钥对交易进行签名
...
PPOS.prototype.send = async function (params, other) {
    if (this.privateKey === undefined || this.chainId === undefined)
        return Promise.reject("Please call updateSetting to set privateKey or chainId");
    try {
